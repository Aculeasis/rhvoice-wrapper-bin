...
apt-get update -qq
apt-get install --no-install-recommends -y -qq git scons build-essential python3 python3-pip flac libspeechd-dev pkg-config
python3 -m pip install -U pip
python3 -m pip install -U setuptools wheel lxml
